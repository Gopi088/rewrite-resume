        ...
        <>
          ...
          <div className="absolute right-0 z-50 mt-2 w-80 rounded-none border-2 border-black bg-white p-4 shadow-sw-default">
            ...
            <input
              ...
              className="mt-1 w-full rounded-none border-2 border-black bg-white px-3 py-2 text-sm text-black focus:border-blue-700 focus:outline-none focus:ring-1 focus:ring-blue-700"
            />
            ...
            <div className="mt-4 flex items-center justify-between gap-2">
              <button
                type="button"
                onClick={handleClose}
                className="rounded-none border-2 border-black px-3 py-2 text-xs font-semibold text-black hover:bg-white"
              >
                {t('common.cancel')}
              </button>
              <button
